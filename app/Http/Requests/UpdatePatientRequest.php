...
class UpdatePatientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ssn' => ['nullable', 'string', 'max:20', Rule::unique('patients', 'ssn')->ignore($this->route('patient'))],
            ...
            'email' => ['required', 'email', 'max:255', Rule::unique('patients', 'email')->ignore($this->route('patient'))],
